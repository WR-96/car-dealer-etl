...
module Workshop
  class Bill < ApplicationRecord
    attribute :date, :date
    validates :client_name, :rfc, :date, :service, :sub_total, :tax_percentage, 
    ...
    validates :tax_percentage, numericality: { only_integer: true, greater_than: 0 }
    validates :sub_total, :tax_amount, :total, numericality: { greater_than: 0 } 
  end
end
